    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                ...
                Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubher,
                fur fvfg nebhaq gur ubhrfr. The Gothon stops, tries
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                Gothon shoots yuo riht in the back killing you. As
